    ...
    projects: [
      {
        ...
        image: 'https://bluescreat-z5qxfsrw.manus.space/manus-storage/gasbone-mango-energy_00b8dbed_b0b68ebc.png',
        softwares: [
      ...
      },
      {
        ...
        image: 'https://bluescreat-z5qxfsrw.manus.space/manus-storage/waku-energy-drink_486fc6b5_3d2fd479.png',
        softwares: [
          { name: 'Illustrator', icon: 'https://cdn-icons-png.flaticon.com/512/5968/5968502.png' },
          { name: 'Photoshop', icon: 'https://cdn-icons-png.flaticon.com/512/5968/5968520.png' },
        ],
      ...
      },
      {
        ...
        image: 'https://bluescreat-z5qxfsrw.manus.space/manus-storage/blues-creative-agency-web_a1836074_8749c866.png',
        softwares: [
      ...
      },
      {
        ...
        image: 'https://bluescreat-z5qxfsrw.manus.space/manus-storage/lumma-smart-hydration_854cb7d1_8b7f12f4.png',
        softwares: [
          { name: 'Illustrator', icon: 'https://cdn-icons-png.flaticon.com/512/5968/5968502.png' },
          { name: 'Photoshop', icon: 'https://cdn-icons-png.flaticon.com/512/5968/5968520.png' },
          { name: 'Premiere Pro', icon: 'https://cdn-icons-png.flaticon.com/512/5968/5968534.png' },
      ...
      {
        id: 5,
        title: 'Fuego — Restaurante Bar',
        category: 'Desarrollo Digital',
        description: 'Plataforma web interactiva para descubrir el restaurante, explorar su menú y realizar pedidos conectados con WhatsApp e inteligencia artificial',
        image: 'https://bluescreat-z5qxfsrw.manus.space/manus-storage/fuego-restaurante-bar_7470f4a5_bdce3d5f.png',
        fullDescription: 'Para Fuego — Restaurante Bar creamos una plataforma web completa e interactiva diseñada para convertir la experiencia digital en una extensión del restaurante. El sitio reúne información de marca, gastronomía y comunidad en una interfaz clara, atractiva y preparada para facilitar la conversión de visitantes en clientes.\n\nEl proyecto incluyó:\n\n• Catálogo digital de comidas con platos típicos, platos especiales y cocteles, organizado para facilitar la exploración del menú\n• Flujo de pedidos integrado con WhatsApp para que los clientes puedan enviar sus solicitudes de forma rápida y directa\n• Automatización de la atención mediante un agente de inteligencia artificial conectado al canal de WhatsApp, capaz de responder las peticiones iniciales de los clientes\n• Enrutamiento automático del pedido confirmado hacia el jefe de cocina para que pueda comenzar la preparación sin demoras\n• Sección de opiniones reales para fortalecer la confianza y mostrar la experiencia de la comunidad del restaurante\n• Ubicación real del establecimiento y datos útiles para facilitar las visitas\n• Contenido institucional con la misión y la visión de Fuego\n• Espacios para presentar la comunidad, la propuesta gastronómica y la personalidad del restaurante\n• Arquitectura responsive y navegación optimizada para que la experiencia funcione correctamente en móviles, tablets y computadores\n\nEl resultado es una experiencia digital que conecta la identidad de Fuego con su operación diaria: el visitante descubre la propuesta, consulta el menú, realiza su pedido por WhatsApp y activa un flujo automatizado que mantiene alineados al cliente, al agente de IA y al equipo de cocina.',
        softwares: [
          { name: 'Tailwind CSS', icon: 'https://cdn.simpleicons.org/tailwindcss/06B6D4' },
          { name: 'React', icon: 'https://cdn.simpleicons.org/react/61DAFB' },
          { name: 'TypeScript', icon: 'https://cdn.simpleicons.org/typescript/3178C6' },
  ...
  en: {
    ...
    projects: [
      ...
      },
      {
        ...
        description: 'Interactive web platform for discovering the restaurant, exploring its menu and placing orders connected to WhatsApp and artificial intelligence',
        image: 'https://bluescreat-z5qxfsrw.manus.space/manus-storage/fuego-restaurante-bar_7470f4a5_bdce3d5f.png',
        fullDescription: 'For Fuego — Restaurante Bar, we created a complete interactive web platform designed to turn the digital experience into an extension of the restaurant. The site brings together brand information, gastronomy and community in a clear, engaging interface prepared to turn visitors into customers.\n\nThe project included:\n\n• Digital food catalogue with traditional dishes, special dishes and cocktails, organized for easy menu exploration\n• WhatsApp ordering flow so customers can send their requests quickly and directly\n• Automated customer service through an artificial intelligence agent connected to WhatsApp, able to respond to initial customer requests\n• Automatic routing of confirmed orders to the head chef so preparation can begin without delays\n• Real customer opinions section to strengthen trust and showcase the restaurant community\n• Real location and useful information to make in-person visits easier\n• Institutional content presenting Fuego\'s mission and vision\n• Dedicated spaces to showcase the community, culinary proposal and personality of the restaurant\n• Responsive architecture and optimized navigation for mobile, tablet and desktop experiences\n\nThe result is a digital experience that connects Fuego\'s identity with its daily operation: visitors discover the concept, explore the menu, place an order through WhatsApp and activate an automated workflow that keeps the customer, AI agent and kitchen team aligned.',
        softwares: [
          { name: 'Tailwind CSS', icon: 'https://cdn.simpleicons.org/tailwindcss/06B6D4' },
          { name: 'React', icon: 'https://cdn.simpleicons.org/react/61DAFB' },
          { name: 'TypeScript', icon: 'https://cdn.simpleicons.org/typescript/3178C6' },
